...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksWithConditionsReturnList() {
        ...
        Book book1 = new Book("hobbit", "ccccc", 2008);
        Book book2 = new Book("wladca piercieni", "bbbb", 2012);
        Book book3 = new Book("gra o tron", "aaaa", 2016);
        Book book4 = new Book("Java", "henryk iwan", 2010);
    ...
    public void testListBooksInHandsOfZeroBooks() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user = new LibraryUser("ja", "jak", "5555555");
        List<Book> resultListOfBooks = generateListOfNBooks(0);
        when(libraryDatabaseMock.listBooksInHandsOf(anyString())).thenReturn(resultListOfBooks);
    ...
    public void testListBooksInHandsOfOneBook() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user = new LibraryUser("jakub", "jak", "5555555");
